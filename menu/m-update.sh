...
wget -q -O /usr/bin/m-bot "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/m-bot.sh" && chmod +x /usr/bin/m-bot
wget -q -O /usr/bin/m-theme "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/m-theme.sh" && chmod +x /usr/bin/m-theme
wget -q -O /usr/bin/m-vmess "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/m-vmess.sh" && chmod +x /usr/bin/m-vmess
wget -q -O /usr/bin/m-vless "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/m-vless.sh" && chmod +x /usr/bin/m-vless
...
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/tendang.sh" && chmod +x /usr/bin/tendang
wget -q -O /usr/bin/bottelegram "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/bottelegram.sh" && chmod +x /usr/bin/bottelegram
wget -q -O /usr/bin/xraylimit "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/xraylimit.sh" && chmod +x /usr/bin/xraylimit
wget -q -O /usr/bin/trialvmess "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/trialvmess.sh" && chmod +x /usr/bin/trialvmess
